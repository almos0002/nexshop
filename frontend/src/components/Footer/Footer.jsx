  ...
  return (
    <footer className="bg-gray-800 text-white">
      <div className="container mx-auto px-4 py-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li className="flex items-start">
                ...
                <span className="text-gray-400">support@nexshop.com</span>
              </li>
              <li className="flex items-start">
                <svg className="w-5 h-5 text-gray-400 mr-2 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="mt-8 pt-6 border-t border-gray-700 text-center sm:flex sm:justify-between sm:text-left">
          <p className="text-gray-400">&copy; {new Date().getFullYear()} NexShop. All rights reserved.</p>
